# -*- coding: utf-8 -*-
#
# colour-demosaicing documentation build configuration file, created by
...
version = '{0}.{1}'.format(colour_demosaicing.__major_version__,
                           colour_demosaicing.__minor_version__)
# The full version, including alpha/beta/rc tags.
release = str(colour_demosaicing.__version__)
...
htmlhelp_basename = 'ColourDemosaicingDoc'
...
latex_documents = [
    ('index', 'Colour_Demosaicing.tex', u'Colour - Demosaicing Documentation',
...
texinfo_documents = [
    ('index', 'Colour_Demosaicing', u'Colour - Demosaicing Documentation',
     u'Colour Developers', 'Colour - Demosaicing',
